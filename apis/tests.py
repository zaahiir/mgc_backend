...
class TeeBookingTestCase(APITestCase):
    def setUp(self):
        """Set up test data for tee booking functionality"""
        # Create test member
    ...
    def test_get_tees_by_course(self):
        ...
        tee_data = response.data['data'][0]
        self.assertEqual(tee_data['holeNumber'], 9)
        self.assertEqual(tee_data['pricePerPerson'], '25.00')
    ...
    def test_create_booking(self):
        ...
        self.assertEqual(response.data['data']['totalPrice'], '50.00')
